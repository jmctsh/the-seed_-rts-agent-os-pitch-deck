...
export const slides: SlideData[] = [
  {
    ...
    speakerNotes: [
      ...
      "我们的愿景是：在今天的生成式 AI 时代，复兴经典 RTS 游戏在过去的辉煌。",
      "我们基于 The Seed 框架，能让开发者快速搭建游戏智能体，最终我们希望向所有 RTS 玩家推广“使用 AI 智能体对战”的游戏模式。"
    ],
    content: (
  ...
  },
  {
    ...
    speakerNotes: [
      ...
      "RTS 也是一样，需要先系统学习、练习基本功。于是我苦练 3 年红警，结果玩吐了，现在我想换个游戏，我想换魔兽，结果我发现我又要从头开始练！",
      "这就是一个巨大的痛点。"
    ],
    content: (
  ...
  },
  {
    ...
    speakerNotes: [
      ...
      "真人对战强度大压力大，还有人骂人、挂机、开挂、炸鱼。于是像我一样的一批人选择只打电脑，但传统 AI 的行为非常死板，因此玩家要么只能一次打很多电脑，另一种是给电脑双倍金钱或更快的造兵速度。",
  ...
  },
  {
    ...
    speakerNotes: [
      ...
      "对于 PVP 玩家来说，智能体提升了上限，AI 负责基础操作，玩家可以腾出手去多线操作；",
